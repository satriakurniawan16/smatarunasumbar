...
import { GraduationCap, FileText, Calendar, ChevronRight } from "lucide-react";

const steps = [
  { icon: FileText, title: "Pendaftaran Online", desc: "Isi formulir dan unggah dokumen persyaratan." },
  { icon: Calendar, title: "Tes Seleksi", desc: "Tes akademik, kesehatan, dan wawancara." },
  { icon: GraduationCap, title: "Pengumuman", desc: "Hasil diumumkan melalui website resmi." },
];

export function Register({ whatsapp }: { whatsapp: string }) {
  return (
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            ...
            <h2 className="text-4xl md:text-5xl font-bold mt-3">Bergabung dengan Taruna</h2>
            <div className="gold-divider mx-auto mt-6" />
            <p className="text-white/75 mt-6 max-w-2xl mx-auto">
              Tahun Ajaran 2026/2027 telah dibuka. Jadilah bagian dari generasi pemimpin masa depan.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-6 mb-10">
            {steps.map((s, i) => (
              <div key={i} className="bg-white/5 backdrop-blur-sm p-6 rounded-2xl border border-white/10 relative">
                ...
                <s.icon className="w-8 h-8 text-gold mb-4 mt-2" />
